...
{
    public class ChaturashitiSamaDasa : BaseDasaSystem
    {
        protected override double GetTotalYears()
        {
            return 84.0; // Total duration of ChaturashitiSama dasa
        }
        ...
        protected override Dictionary<PlanetName, double> GetPlanetYears()
        {
            ...
            {
                { PlanetName.Sun, 10.5 },
                { PlanetName.Moon, 10.5 },
                { PlanetName.Mars, 10.5 },
                { PlanetName.Mercury, 10.5 },
                { PlanetName.Jupiter, 10.5 },
                { PlanetName.Venus, 10.5 },
                { PlanetName.Saturn, 10.5 },
                { PlanetName.Rahu, 10.5 }
            };
        }
