...
{
    public class DvadashottariDasa : BaseDasaSystem
    {
        protected override double GetTotalYears()
        {
            return 112.0; // Total duration of Dvadashottari dasa
        }
        ...
        protected override Dictionary<PlanetName, double> GetPlanetYears()
        {
            return new Dictionary<PlanetName, double>
            {
                ...
                { PlanetName.Moon, 8.0 },
                { PlanetName.Mars, 7.0 },
                { PlanetName.Mercury, 16.0 },
                { PlanetName.Jupiter, 19.0 },
                { PlanetName.Venus, 21.0 },
                { PlanetName.Saturn, 20.0 },
                { PlanetName.Rahu, 16.0 }
            };
        }
