...
{
    public class BrahmaGrahaAshritaDasa : BaseDasaSystem
    {
        protected override double GetTotalYears()
        {
            return 120.0; // Total duration of BrahmaGrahaAshrita dasa
        }
        ...
        protected override Dictionary<PlanetName, double> GetPlanetYears()
        {
            ...
            {
                { PlanetName.Sun, 15.0 },
                { PlanetName.Moon, 15.0 },
                { PlanetName.Mars, 15.0 },
                { PlanetName.Mercury, 15.0 },
                { PlanetName.Jupiter, 15.0 },
                { PlanetName.Venus, 15.0 },
                { PlanetName.Saturn, 15.0 },
                { PlanetName.Rahu, 15.0 }
            };
        }
