...
{
    public class ShattrimshatSamaDasa : BaseDasaSystem
    {
        protected override double GetTotalYears()
        {
            return 36.0; // Total duration of ShattrimshatSama dasa
        }
        ...
        protected override Dictionary<PlanetName, double> GetPlanetYears()
        {
            return new Dictionary<PlanetName, double>
            {
                ...
                { PlanetName.Moon, 4.5 },
                { PlanetName.Mars, 4.5 },
                { PlanetName.Mercury, 4.5 },
                { PlanetName.Jupiter, 4.5 },
                { PlanetName.Venus, 4.5 },
                { PlanetName.Saturn, 4.5 },
                { PlanetName.Rahu, 4.5 }
            };
        }
